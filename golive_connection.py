...
import nacl.secret
import nacl.utils
from discord.voice.gateway import VoiceWebSocket as DiscordVoiceWebSocket
from discord.voice.state import SocketReader
...
class GoLiveConnection:
    ...
    DiscordVoiceWebSocket.from_state().  The patched identify(),
    ...
    def voice_client(self) -> discord.VoiceClient:
        # DiscordVoiceWebSocket.from_state() uses voice_client.loop
    ...
    async def connect(self, timeout: float = 30.0) -> None:
        ...
        self.ws = await DiscordVoiceWebSocket.from_state(
