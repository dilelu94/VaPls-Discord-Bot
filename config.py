...
TOKEN = os.getenv("TOKEN") or os.getenv("DISCORD_BOT_TOKEN") or os.getenv("DISCORD_TOKEN")
...
# Hugging Face token (opcional, para APIs / descargas de modelos de Hugging Face).
...
VOICE_IDLE_TIMEOUT_SECONDS = float(os.getenv("VOICE_IDLE_TIMEOUT_SECONDS", "300"))
