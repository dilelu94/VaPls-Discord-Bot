...
_FALLBACK_USERS: dict[int, dict] = {
    ...
    285116759525031937: {
        ...
        "greeting": [
            ...
            {
                "path": "Canciones/Mila/04 - He Follado con Cocodrilos.mp3",
                "weight": 1
            }
        ],
        "traits": [
    ...
    211354006805676032: {
        "name": "Miles",
        "greeting": "Miles/Fish Carrot.m4a",
        "traits": [
            "pronombres: él",
            "nombre real: Leonel",
            "es hincha de Boca",
...
def get_allowed_instagram_usernames() -> set[str]:
    ...
    Only includes Discord users that have an ``instagram`` field in USERS.
    NON_DISCORD_MEMBERS (e.g. Bibi) are intentionally excluded.
