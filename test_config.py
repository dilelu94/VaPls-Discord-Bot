...
class TestConfig(unittest.TestCase):
    @patch.dict(os.environ, {
        "TOKEN": "test_token", 
        "MODEL_PATH_ES": "test_model_es", 
        "MODEL_PATH_EN": "test_model_en", 
    ...
    def test_config_loading(self):
        ...
        self.assertEqual(config.MODEL_PATH_ES, "test_model_es")
        self.assertEqual(config.MODEL_PATH_EN, "test_model_en")
