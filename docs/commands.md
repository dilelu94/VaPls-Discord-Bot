...
| `/vapls` | Pregunta al bot Gemini sin memoria. | `personaCommand`, `geminiClient`, `analytics` |
| `/indio` | Conversación con memoria corta (persona “indio”). | `personaCommand`, `geminiClient`, `analytics` |
